    ...
    return (
      <div className="container mt-100">
        ...
        <p>
          ...
          در کمال آرامش در کلاس فوق برنامه یا آزمون اینترنتی شرکت نماید، شرکت ها
          و سازمانها به جای آنکه همکاران خود را از سراسر کشور یا استان برای شرکت
          در یک دوره آموزشی فراخوان نمایند و هزینه های گزاف متقبل شوند، می
